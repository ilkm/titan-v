    ...
    *select_interact_top_y = ui.cursor().min.y;
    Frame::NONE.inner_margin(Margin::symmetric(12, 10)).show(ui, |ui| {
        ...
        ui.vertical(|ui| {
            ...
            metrics::paint_device_status_and_metrics(ui, lang, app, &preview_key, online, is_sel, label_s, inner_w, addr_s, win_n, select_split_y);
            remark::paint_device_remark_block(app, ui, i, lang, inner_w);
        });
    });
}
