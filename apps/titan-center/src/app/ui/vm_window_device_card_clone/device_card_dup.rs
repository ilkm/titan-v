...
fn paint_device_card_column(
    ...
    *select_interact_top_y = ui.cursor().min.y;
    Frame::NONE
        ...
        .show(ui, |ui| {
            paint_vm_card_metrics_and_remark(app, ui, meta, select_split_y);
        });
}

fn paint_vm_card_metrics_and_remark(
    app: &mut CenterApp,
    ui: &mut egui::Ui,
    meta: VmCardMeta<'_>,
    select_split_y: &mut f32,
    ...
    ui.vertical(|ui| {
        ...
        paint_vm_card_metrics(ui, app, meta, inner_w, select_split_y);
