...
pub(crate) const PERSIST_KEY: &str = "titan_host_ui_v1";

pub use crate::ui_persist::{AgentBindingRow, HostUiPersist};
...
impl HostUiPersist {
    ...
    pub(crate) fn bindings_spec(&self) -> Result<AgentBindingsSpec, String> {
...
pub struct HostApp {
    ...
    pub(crate) binding_vm: String,
    pub(crate) binding_addr: String,
